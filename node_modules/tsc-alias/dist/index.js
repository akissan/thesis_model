...
function replaceTscAliasPaths(options = {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const AliasTrie = new utils_1.TrieNode();
        Object.keys(paths)
            .map((alias) => {
        ...
        const replaceImportStatement = ({ orig, file, alias }) => {
            ...
            if (isAlias) {
                for (let i = 0; i < alias.paths.length; i++) {
                    const absoluteAliasPath = (0, helpers_1.getAbsoluteAliasPath)(alias.basePath, alias.paths[i]);
                    if (!(0, helpers_1.existsResolvedAlias)(alias.prefix.length == requiredModule.length
        ...
        const replaceBaseUrlImport = ({ orig, file }) => {
            var _a, _b;
            const requiredModule = (_b = (_a = orig.match((0, utils_1.newStringRegex)())) === null || _a === void 0 ? void 0 : _a.groups) === null || _b === void 0 ? void 0 : _b.path;
            assert(typeof requiredModule == 'string', `Unexpected import statement pattern ${orig}`);
            ...
            if ((0, helpers_1.existsResolvedAlias)(`${outPath}/${requiredModule}`)) {
                let relativePath = normalizePath((0, path_1.relative)((0, path_1.dirname)(file), (0, helpers_1.getAbsoluteAliasPath)(outPath, '')));
        ...
        const replaceAlias = (file, resolveFullPath) => __awaiter(this, void 0, void 0, function* () {
            ...
            let tempCode = code;
            tempCode = (0, utils_1.replaceSourceImportPaths)(tempCode, file, (orig) => {
                var _a, _b;
                const alias = AliasTrie.search((_b = (_a = orig.match((0, utils_1.newStringRegex)())) === null || _a === void 0 ? void 0 : _a.groups) === null || _b === void 0 ? void 0 : _b.path);
                return alias
            ...
            tempCode = (0, utils_1.replaceSourceImportPaths)(tempCode, file, (orig) => replaceBaseUrlImport({
                orig,
                file
            }));
            if (resolveFullPath) {
        ...
        if (options.watch) {
            ...
            const onFileChange = (file) => __awaiter(this, void 0, void 0, function* () { return yield replaceAlias(file, options === null || options === void 0 ? void 0 : options.resolveFullPaths); });
