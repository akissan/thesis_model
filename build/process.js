    ...
    constructor({ processTime, name, unit, tables, block, id, processData, options, onFinish, }) {
        ...
        this.prefinish = () => {
            ...
            if (this.block) {
                ...
                if ((_b = (_a = this.options) === null || _a === void 0 ? void 0 : _a.onFinish) === null || _b === void 0 ? void 0 : _b.occupeOnFinish) {
                    const newProcess = (_d = (_c = this.tables.blocks[this.block]).assignProcess) === null || _d === void 0 ? void 0 : _d.call(_c, this.tables.blocks[this.block], this.unit)();
                }
            }
            if ((_f = (_e = this.options) === null || _e === void 0 ? void 0 : _e.onFinish) === null || _f === void 0 ? void 0 : _f.unitRequestState) {
                this.tables.units[this.unit].requestState =
                    this.options.onFinish.unitRequestState;
            }
            if ((_h = (_g = this.options) === null || _g === void 0 ? void 0 : _g.onFinish) === null || _h === void 0 ? void 0 : _h.unitStatus) {
